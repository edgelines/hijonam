    ...
    <div class="row Artworks-Div-Bottom">
        ...
        <div class="col-sm-12 col-md-10 col-lg-10">
            ...
            <div class="row mt-4">
                ...
                <!-- <ArtworksImgList :imgList="imgList" :imgData="imgData" /> -->


                <!-- <div class="row d-flex align-items-end"> -->

                <!-- <masonry-grid class="container" :gap="50" :defaultDirection="end" :align="justify" :column="4"
                                                                                                                                                                                            :columnSize="0" :columnSizeRatio="0">
                                                                                                                                                                                            ...
                                                                                                                                                                                            <div class="item" v-for="(item, index) in imgData" key="item">
                                                                                                                                                                                                {{ item.fileName }}
                                                                                                                                                                                                <div class="mb-4" @click="$router.push('/artworks/' + imgData[index].imgID)">
                                                                                                                                                                                                    <img class="img-list mb-1" :src="'/img/Artworks/' + item.fileName" />
                                                                                                                                                                                                    <div class="imgTilteFont text-start">{{ imgData[index].imgTitle }}</div>
                                                                                                                                                                                                </div>
                                                                                                                                                                                            </div>
                                                                                                                                                                                        </masonry-grid> -->
                <masonry-wall :items="imgList" :ssr-columns="60" :column-width="370" :gap="40">
